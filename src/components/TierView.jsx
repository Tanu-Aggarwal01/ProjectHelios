      ...
      <div className="tier-body">
        ...
        <div className="tier-side">
          <div className="tier-panel">
            ...
            <p className="panel-note">The top tier has been automatically categorized into topics by the Posture Agent. Trigger categorization on remaining tiers to organize their sites.</p>
          </div>
